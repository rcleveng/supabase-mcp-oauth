...
type ProviderMetadata struct {
	...
	// *** NOTE: This doesn't seem to be part of the spec, but MCP servers are looking for it.
	// OPTIONAL. JSON array containing a list of the OAuth 2.0 code_challenge_method
	// values that this OP supports, as specified in OAuth 2.0 Multiple Response
	// Type Encoding Practices [OAuth.Responses]. If omitted, the default for
	// Dynamic OpenID Providers is ["S256"].
	CodeChallengeMethodsSupported []string `json:"code_challenge_methods_supported,omitempty"`
}

func (s *WellknownServer) HandleOidcDiscovery(w http.ResponseWriter, r *http.Request) {
	slog.Debug("HandleOidcDiscovery: Received request", "method", r.Method, "url", r.URL.String())
